      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="border-white/10 bg-[#111113] shadow-2xl shadow-black/50">
          <CardHeader className="text-center space-y-2 pb-6">
            <CardTitle className="text-2xl font-bold tracking-tight font-heading">Crie sua conta</CardTitle>
            <CardDescription className="text-muted-foreground">
              Comece a automatizar sua distribuição de conteúdo hoje mesmo.
            </CardDescription>
          </CardHeader>
